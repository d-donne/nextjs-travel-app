      ...
      <div className="relative flex flex-1 z-20 flex-col xl:w-1/2">
        ...
        <div className="flex flex-col w-full gap-3 sm:flex-row">
          ...
          <Button
            ...
            title="How we work"
            icon="/play.svg"
            variant="btn_white_text outline outline-1 outline-orange-300 hover:text-white hover:bg-orange-300 hover:outline-none"
          />
        </div>
      </div>
        ...
        <div className="relative z-20 w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8 ">
          ...
          <div className="flexBetween">
            <div className="flex flex-col">
              ...
              <p className="bold-20 text-white">188.35 mi</p>
            </div>
            <div className="flex flex-col">
              <p className="regular-16 block text-gray-20">Elevation</p>
              <p className="bold-20 text-white">3.095km</p>
            </div>
          </div>
        </div>
      </div>
